...
import * as strings from 'ReferralPageWebPartStrings';
import ReferralPage from './components/ReferralPage';
import { IReferralPageProps } from './components/IReferralPageProps';
...
export default class ReferralPageWebPart extends BaseClientSideWebPart<IReferralPageWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IReferralPageProps> = React.createElement(
      ReferralPage,
      {
